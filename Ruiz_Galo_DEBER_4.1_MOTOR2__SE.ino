 ...
 * DEBER 4.1: CAD y PWM
 * Nombre: Galo Ruiz
 * Programacion del motor 2 va encender mediante un boton, obtener los datos de CAD, V y PWM se deben visulizar en una LCD para cada motor.
 */
...
void loop() {
  if(digitalRead(btn1)==LOW){      //Es bajo debido al diseño del boton
