 ...
 * Nombre: Galo Ruiz
 * /////////////ESCLAVO1/////////////
 * Para que encienda los leds que estan conectados al esclavo1,ingrese la letra 'A' caso contrario no van encenderse
 */
...
while(Wire.available()){ // Detecta si hay un dato pendiente para ser leido
    ...
    while(dato=='A'){    //Permite encender los leds que estan conectados al esclavo 1,va cumplir cuando se ingresa la letra 'A'
